...
@section('content')
    <div class="card">
        <div class="card-header">
            <span class="float-left">Create new Department</span>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('backend_department_store') }}" enctype="multipart/form-data" data-parsley-validate class="bg-light shadow p-3">
                @csrf
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-8 offset-md-3">
                        <button type="submit" class="btn btn-sm btn-success">
                           <i class="fa fa-upload"></i> Save Department
                        </button>
                    </div>
                </div>
            </form>
