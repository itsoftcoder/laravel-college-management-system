...
@section('title')
    Add new driving teacher
@endsection

@section('content')
    <div class="card">
        <div class="card-header">
            <p class="float-left">Create new Driving Teacher</p>
            <a href="{{ route('backend_driving_teacher_manage') }}" class="btn btn-sm btn-success float-right"><i class="fa fa-sellsy"></i>  Manage Driving Teacher</a>
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('backend_driving_teacher_store') }}" enctype="multipart/form-data" data-parsley-validate class="bg-light shadow p-3">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="work_hour" class="form-control @error('work_hour') is-invalid @enderror" name="work_hour" value="{{ old('work_hour') }}" required autocomplete="work_hour">
                                @error('work_hour')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-8 offset-md-3">
                        <button type="submit" class="btn btn-sm btn-success">
                            <i class="fa fa-upload"></i>  Save Driving Teacher
                        </button>
                    </div>
                </div>
            </form>
