...
@section('content')
    <div class="card">
        <div class="card-header">
            <p class="float-left">Create new lab</p>
            <a href="{{ route('backend_lab_manage') }}" class="btn btn-sm btn-success float-right"><i class="fa fa-sellsy"></i>  Manage lab</a>
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('backend_lab_store') }}" enctype="multipart/form-data" data-parsley-validate class="bg-light shadow p-3">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input id="quantity" type="text" class="form-control @error('quantity') is-invalid @enderror" name="quantity" value="{{ old('quantity') }}" pattern="^[0-9]+$" required placeholder=" how many quantity input here" autocomplete="quantity">
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-8 offset-md-3">
                        <button type="submit" class="btn btn-sm btn-success">
                            <i class="fa fa-upload"></i>  Save lab
                        </button>
                    </div>
                </div>
            </form>
