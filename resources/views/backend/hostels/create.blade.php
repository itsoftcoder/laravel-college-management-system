...
@section('content')
    <div class="card">
        <div class="card-header">
                <p class="float-left">Create new hostel</p>
                <a href="{{ route('backend_hostel_manage') }}" class="btn btn-sm btn-success float-right"><i class="fa fa-sellsy"></i>  Manage hostel</a>
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('backend_hostel_store') }}" enctype="multipart/form-data" data-parsley-validate class="bg-light shadow p-3">
                @csrf
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-8 offset-md-3">
                        <button type="submit" class="btn btn-sm btn-success">
                            <i class="fa fa-upload"></i>  Save hostel
                        </button>
                    </div>
                </div>
            </form>
