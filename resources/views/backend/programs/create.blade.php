...
@section('content')
    <div class="card">
        <div class="card-header">
            <p class="float-left">Create new program</p>
            <a href="{{ route('backend_program_manage') }}" class="btn btn-sm btn-success float-right"><i class="fa fa-sellsy"></i>  Manage program</a>
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('backend_program_store') }}" enctype="multipart/form-data" data-parsley-validate class="bg-light shadow p-3">
                @csrf
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-8 offset-md-3">
                        <button type="submit" class="btn btn-sm btn-success">
                            <i class="fa fa-upload"></i>  Save Program
                        </button>
                    </div>
                </div>
            </form>
