...
@section('title')
    {{ $book_category->name }} book | Shariatpur Technical school and collage
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ $book_category->name }}</li>
...
@section('content')
    ...
    @foreach($books as $book)
        ...
        <div class="card mb-2">
            <div class="card-header" style="background: linear-gradient(#f1a899,#EED3D7,#f1a899);"><span class="font-weight-bold">Category Name : </span> <span>{{ $book->book_category->name }}</span></div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
