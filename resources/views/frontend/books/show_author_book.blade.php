...
@section('title')
Author book | Shariatpur Technical school and collage
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">Author Book</li>
...
@section('content')
    ...
    @foreach($books as $book)
        ...
        <div class="card mb-2">
            <div class="card-header" style="background: linear-gradient(#f1a899,#EED3D7,#f1a899);"><span class="font-weight-bold">Author Name : </span> <span>{{ $book->author_name }}</span></div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
