...
@section('content')
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                                ...
                                <p><strong class="text-success">Description : </strong><span>{{ $pool->description }}</span></p>
                        </div>
                    </div>
                </div>
            ...
            @if($pool->photos->count() <= 0)
                <p class="text-danger shadow-sm p-3 font-weight-bold bg-dark">This pool is no photos</p>
            @else
                <?php
                    $photos = \App\Photo::orderBy('id','DESC')->where('pool_id',$pool->id)->paginate(5);
                ?>
