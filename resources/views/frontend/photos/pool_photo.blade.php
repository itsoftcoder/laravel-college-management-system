         ...
         @extends('layouts.master')
            ...
            @section('breadcrumb')
                        ...
                        <li class="breadcrumb-item">{{ $pool->name }} all photos</li>
            ...
            @section('content')
                ...
                <div class="card mb-2">
                    <div class="card-header font-weight-bold" style="background: linear-gradient(#f1a899,#EED3D7,#f1a899);">{{ $pool->name }}  All Photos Below here</div>
                    <div class="card-body">
