         ...
         @extends('layouts.master')
            @section('title')
                student class xi electronic 1st shift | Shariatpur Technical school and collage
            @endsection
            ...
            @section('breadcrumb')
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('frontend_student_xi') }}" class="">Class xi</a></li>
            ...
            @section('content')
                <div class="card mb-2">
                    <div class="card-header font-weight-bold" style="background: linear-gradient(#f1a899,#EED3D7,#f1a899);">Class eleven electronic Department First Shift Students Below Here</div>
                </div>

                <?php
                $classes = \App\Classe::where('name','eleven')->get();
