         ...
         @extends('layouts.master')
            @section('title')
                student class xi fish culture 1st shift | Shariatpur Technical school and collage
            @endsection
            ...
            @section('content')
                <div class="card mb-2">
                    <div class="card-header font-weight-bold" style="background: linear-gradient(#f1a899,#EED3D7,#f1a899);">Class eleven fish culture Department First Shift Students Below Here</div>
                </div>
