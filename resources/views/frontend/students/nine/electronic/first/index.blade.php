         ...
         @extends('layouts.master')
            @section('title')
                student class ix electronic 1st shift | Shariatpur Technical school and collage
            @endsection
            ...
            @section('content')
                <div class="card mb-2">
                    <div class="card-header font-weight-bold" style="background: linear-gradient(#f1a899,#EED3D7,#f1a899);">Class Nine Electronic Department First Shift Students Below Here</div>
                </div>
                ...
                if ($departments->count() <= 0 || $classes->count() <= 0){
                    echo "<p class='shadow-sm p-2 bg-white rounded text-danger'>No student here for this department or Class</p>";
                }else{
