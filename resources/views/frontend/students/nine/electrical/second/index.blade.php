         ...
         @extends('layouts.master')
            ...
            @section('content')
                ...
                <div class="card mb-2">
                    <div class="card-header font-weight-bold" style="background: linear-gradient(#f1a899,#EED3D7,#f1a899)">Class Nine Electrical Department Second Shift Students Below Here</div>
                </div>
