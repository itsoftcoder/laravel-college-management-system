         ...
         @extends('layouts.master')
            @section('title')
                student class xii computer 2nd shift | Shariatpur Technical school and collage
            @endsection
            ...
            @section('content')
                <div class="card mb-2">
                    <div class="card-header font-weight-bold" style="background: linear-gradient(#f1a899,#EED3D7,#f1a899);">Class Twelve Computer Department Second Shift Students Below Here</div>
                </div>
