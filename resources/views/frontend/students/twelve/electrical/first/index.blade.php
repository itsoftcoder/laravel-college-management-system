         ...
         @extends('layouts.master')
            @section('title')
                student class xii electrical 1st shift | Shariatpur Technical school and collage
            @endsection
            ...
            @section('breadcrumb')
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('frontend_student_xii') }}" class="">Class xii</a></li>
                        <li class="breadcrumb-item"><a href="#" class="">Electrical</a></li>
                        <li class="breadcrumb-item">1st shift</li>

            @endsection

            @section('content')
                <div class="card mb-2">
                    <div class="card-header font-weight-bold" style="background: linear-gradient(#f1a899,#EED3D7,#f1a899);">Class twelve Electrical Department First Shift Students Below Here</div>
                </div>

                <?php
                $classes = \App\Classe::where('name','twelve')->get();
                $departments = \App\Department::where('name','electrical')->get();
                ...
                $students = \App\Student::orderBy('id','DESC')->where('class_id',$class->id)->where('department_id',$department->id)->where('shift','first_shift')->paginate(7);
