         ...
         @extends('layouts.master')
            @section('title')
                student class xii electronic 1st shift | Shariatpur Technical school and collage
            @endsection
            ...
            @section('content')
                <div class="card mb-2">
                    <div class="card-header font-weight-bold" style="background: linear-gradient(#f1a899,#EED3D7,#f1a899);">Class twelve electronic Department First Shift Students Below Here</div>
                </div>

                <?php
                $classes = \App\Classe::where('name','twelve')->get();
                $departments = \App\Department::where('name','electronic')->get();
