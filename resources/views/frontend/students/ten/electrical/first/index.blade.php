         ...
         @extends('layouts.master')
            @section('title')
                student class x electrical 1st shift | Shariatpur Technical school and collage
            @endsection
            ...
            @section('content')
            <div class="card mb-2">
                <div class="card-header font-weight-bold" style="background: linear-gradient(#f1a899,#ffcebb,#ffe1d7);">Class Ten Electrical Department First Shift Students Below Here</div>
            </div>
