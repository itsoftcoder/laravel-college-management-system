         ...
         @extends('layouts.master')
            @section('title')
                Diploma 1st semester | Shariatpur Technical school and collage
            @endsection
            ...
            @section('breadcrumb')
                        ...
                        <li class="breadcrumb-item">1st semester</li>
            ...
            @section('content')
                ...
                <div class="card mb-2">
                    <div class="card-header font-weight-bold" style="background: linear-gradient(#f1a899,#EED3D7,#f1a899);">Diploma in engineering Computer 1st Shift 1st Semester Students Below Here</div>
                </div>
                ...
                $students = \App\Student::orderBy('id','DESC')->where('class_id',$class->id)->where('department_id',$department->id)->where('semester','1')->paginate(7);
