         ...
         @extends('layouts.master')
            @section('title')
                diploma 5th semester | Shariatpur Technical school and collage
            @endsection
            ...
            @section('breadcrumb')
                        ...
                        <li class="breadcrumb-item"><a href="#" class="">Diploma in engineering</a></li>
                        <li class="breadcrumb-item">5th semester</li>

            @endsection

            @section('content')
                <div class="card mb-2">
                    <div class="card-header font-weight-bold" style="background: linear-gradient(#f1a899,#EED3D7,#f1a899);">Diploma in Engineering Computer Department Seventh Semester Students Below</div>
                </div>

                <?php
                $classes = \App\Classe::where('name','diploma in engineering')->get();
                ...
                $students = \App\Student::orderBy('id','DESC')->where('class_id',$class->id)->where('department_id',$department->id)->where('semester','5')->paginate(7);
