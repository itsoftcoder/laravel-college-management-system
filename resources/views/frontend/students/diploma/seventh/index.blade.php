         ...
         @extends('layouts.master')
            @section('title')
                diploma 7th semester | Shariatpur Technical school and collage
            @endsection
            ...
            @section('breadcrumb')
                        ...
                        <li class="breadcrumb-item">7th semester</li>
            @endsection
            ...
            @section('content')
                ...
                $students = \App\Student::orderBy('id','DESC')->where('class_id',$class->id)->where('department_id',$department->id)->where('semester','7')->paginate(7);
